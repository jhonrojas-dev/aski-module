/** @odoo-module **/
// ---------------------------------------------------------------------------
// VARIANTE OWL 1 (ramas 14 y 15) — generada con .claude/tools/odoo/
// aski_connector_owl1_port.py a partir de la 19.0.
// ---------------------------------------------------------------------------
// La 15 trae el web client nuevo (wowl) pero con OWL **1.4.11**:
...
//   * NO existe `markup()`: el HTML crudo se pinta con `t-raw` (en OWL 2 es
//     `t-out`).
//   * En las plantillas, `t-on-click` NO acepta funciones flecha: hay que llamar
