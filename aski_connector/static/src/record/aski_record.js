odoo.define("aski_connector.record", function (require) {
"use strict";
// ---------------------------------------------------------------------------
...
// solo cambia el envoltorio y como se publican las funciones.
     ...
     */
    function setRecord(model, resId, label) {
     ...
     */
    function clearRecordIf(model, resId) {
    ...
    function onOpenRequest(fn) {
        _subsAbrir.add(fn);
        return () => _subsAbrir.delete(fn);
    }

    return { getRecord: getRecord, hasRecord: hasRecord, setRecord: setRecord, clearRecord: clearRecord, clearRecordIf: clearRecordIf, subscribe: subscribe, requestOpen: requestOpen, onOpenRequest: onOpenRequest };
});
